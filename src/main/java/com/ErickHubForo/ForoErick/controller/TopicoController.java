...
import com.ErickHubForo.ForoErick.domain.DatosRespuestaTopico;
import com.ErickHubForo.ForoErick.domain.topicos.*;
...
public class TopicoController {
    @Autowired
    private CrudTopicoServiceCrudTopicoService crudTopicoService;
    @Autowired
    ...
    public ResponseEntity actualizarTopico(@RequestBody @Valid DatosActualizarTopico datosActualizarTopico){
        Boolean topico = Optional.of(topicoRepository.get(datosActualizarTopico.id())).isPresent();
        if(!topico){
